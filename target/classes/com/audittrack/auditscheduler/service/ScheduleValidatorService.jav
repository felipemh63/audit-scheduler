...
public class ScheduleValidatorService {
    ...
    public boolean isTimeSlotAvailable(Long auditorId, LocalDateTime start, LocalDateTime end, Long excludeAuditId, Long excludeActivityId) {
        // Busca auditorías (excluyendo la que se está editando si aplica)
        ...
        // Busca actividades personales (excluyendo la que se está editando si aplica)
    ...
    // Método para validar solapamiento de intervalos
